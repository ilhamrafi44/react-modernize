...
import DownloadCard from '@modernize/components/shared/DownloadCard';
...
import CustomTextField from '@modernize/components/forms/theme-elements/CustomTextField';
import CustomSelect from '@modernize/components/forms/theme-elements/CustomSelect';
import { IconChevronLeft, IconChevronRight, IconChevronsLeft, IconChevronsRight, IconArrowBackUp, IconCheck, IconX } from '@tabler/icons-react';
    ...
    columnHelper.accessor('name', {
        ...
        cell: info => (
            <Stack direction="row" spacing={2}>
                <Avatar src={info.row.original.imgsrc} alt={info.row.original.imgsrc} sx={{ width: 40, height: 40 }} />
                <Box>
