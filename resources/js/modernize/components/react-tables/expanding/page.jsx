                                                ...
                                                <TableRow>
                                                    <TableCell colSpan={columns.length}>
                                                        <Box p={2}>
                                                            ...
                                                            <Typography>Avatar: <Avatar src={row.original.imgsrc} alt="Avatar" /></Typography>
                                                            <Typography>Name: {row.original.name}.</Typography>
                                                            <Typography>post: {row.original.post}.</Typography>
                                                            <Typography>Project Name: {row.original.pname}</Typography>
                                                            <Typography>Status:
                                                                <Chip
                                                                    sx={{
                                                                        bgcolor:
                                                            ...
                                                            <Typography>budget: ${row.original.budget}</Typography>
                                                        </Box>
                                                    </TableCell>
                                                </TableRow>
                                            ) : null}
